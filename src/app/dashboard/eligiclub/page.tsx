...
export default function EligiClubPage() {
  ...
  // EligiClub liberado em producao (jul/2026) — o gate "em desenvolvimento" saiu daqui.
  // `isento` segue em uso: true = cobranca em modo console (teste), ligado pelo EligiBrain.
