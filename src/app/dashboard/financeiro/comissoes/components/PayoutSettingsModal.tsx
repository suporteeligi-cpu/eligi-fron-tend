...
export default function PayoutSettingsModal({ settings, isMobile, onClose, onSaved }: Props) {
  ...
  async function save() {
    ...
    try {
      const body = {
        frequency,
        weekday: frequency === 'MONTHLY' ? null : weekday,
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              <CheckRow
                ...
                Icon={Briefcase}
                label="Serviços"
                description="Comissões por serviços executados"
              />
              <CheckRow
                ...
                Icon={Package}
                label="Produtos"
                description="Comissões por produtos vendidos"
              />
            </div>
          </div>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              boxShadow: saving ? 'none' : shadows.redSm,
              WebkitTapHighlightColor: 'transparent',
            }}
          >
