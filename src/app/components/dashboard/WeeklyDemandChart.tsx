...
function ChartSkeleton() {
  return (
    <div style={cardStyle}>
      <div style={{ height: '20px', width: '100px', borderRadius: '6px', background: 'rgba(0,0,0,0.06)', marginBottom: '8px' }} />
...
export default function WeeklyDemandChart() {
      ...
      <div style={headerStyle}>
        ...
        {chartData.length > 0 && (
          <div style={{
            ...
            {chartData.reduce((s, d) => s + (d.value ?? 0), 0)} total
          </div>
        )}
      </div>
