...
import { GLASS_CARD, ACCENT } from '../../constants'
        ...
        <div style={{ width: '100%', height: 200 }}>
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={serie} margin={{ top: 8, right: 8, bottom: 0, left: 0 }}>
              ...
              <Area type="monotone" dataKey="real" stroke={ACCENT} strokeWidth={3} fill="url(#recvR)" connectNulls />
              <Area type="monotone" dataKey="projecao" stroke={ACCENT} strokeWidth={2.5} strokeDasharray="5 5" fill="url(#recvR)" fillOpacity={0.4} connectNulls />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
