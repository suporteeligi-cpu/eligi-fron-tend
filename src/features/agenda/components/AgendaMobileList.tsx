          ...
          <div style={{flex:1,position:'relative'}}>
            ...
            {preview?.active && (() => {
              ...
              const previewItems = preview.allItems?.length
                ? preview.allItems.filter(it => it.profId === activeProfId)
                : preview.professionalId === activeProfId
                  ? [{ startTime: preview.time, endTime: addMin(preview.time, preview.duration), duration: preview.duration, serviceName: preview.serviceName ?? '', profId: activeProfId }]
                  : []
